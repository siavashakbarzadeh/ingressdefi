(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('ngx-bootstrap/focus-trap'),require('ngx-bootstrap/component-loader'),exports, require('@angular/core'), require('ngx-bootstrap/utils'), require('ngx-bootstrap/component-loader'), require('ngx-bootstrap/positioning'), require('ngx-bootstrap/focus-trap')) :
    typeof define === 'function' && define.amd ? define('ngx-bootstrap/modal', ['@angular/core','ngx-bootstrap/focus-trap','ngx-bootstrap/component-loader','exports', '@angular/core', 'ngx-bootstrap/utils', 'ngx-bootstrap/component-loader', 'ngx-bootstrap/positioning', 'ngx-bootstrap/focus-trap'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,global.ngxBootstrap.focusTrap,global.ngxBootstrap.componentLoader,(global['ngx-bootstrap'] = global['ngx-bootstrap'] || {}, global['ngx-bootstrap'].modal = {}), global.ng.core, global.utils, global.componentLoader, global.positioning, global.focusTrap));
}(this, (function (ɵngcc0,ɵngcc1,ɵngcc2,exports, core, utils, componentLoader, positioning, focusTrap) { 
var _c0 = ["*"];
'use strict';
...
ModalModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function ModalModule_Factory(t) { return new (t || ModalModule)(); }, imports: [[focusTrap.FocusTrapModule]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(ModalModule, { declarations: [ModalBackdropComponent, ModalDirective, ModalContainerComponent], imports: [ɵngcc1.FocusTrapModule], exports: [ModalBackdropComponent, ModalDirective] }); })();
