...
export declare class RatingComponent implements ControlValueAccessor, OnInit {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<RatingComponent, "rating", never, { "max": "max"; "readonly": "readonly"; "titles": "titles"; "customTemplate": "customTemplate"; }, { "onHover": "onHover"; "onLeave": "onLeave"; }, never, never>;
}
